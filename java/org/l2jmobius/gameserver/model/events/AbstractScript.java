...
public abstract class AbstractScript extends ManagedScript implements IEventTimerEvent<String>, IEventTimerCancel<String>
{
	 ...
	 */
	public void giveAdena(PlayerInstance player, long count, boolean applyRates)
	{
		if (applyRates)
		{
	 ...
	 */
	public static void addFactionPoints(PlayerInstance player, Faction faction, int points)
	{
